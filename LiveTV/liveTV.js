    ...
    modules: [
        {
            ...
            params: [
                ...
                // 🔄 将原来的 "name_filter" 替换为 UA 选择
                {
                    ...
                    value: "okHttp/Mod-1.4.0.0",
                    enumOptions: [
                        { title: "okHttp/Mod-1.4.0.0", value: "okHttp/Mod-1.4.0.0" },
...
let CURRENT_UA = "okHttp/Mod-1.4.0.0";

async function loadLiveItems(params = {}) {
    try {
        const url = params.url || "";
        const groupFilter = params.group_filter || "";
        const ua = params.ua || "okHttp/Mod-1.4.0.0";   // 新增：UA 选择
