// ==UserScript==
// @name         GitHub+ 玻璃风格 + ScriptHub（固定工具条·结构复刻·移动横滑·高对比暗黑）
// @namespace    https://mikephie.site/
// @version      2.6.0
// @description  固定横向工具条（桌面顶部/移动底部横滑）；ScriptHub 路由完全复刻避免 Invalid URL；暗黑高对比霓虹；短标签；快捷键 r/d/p/u/f/s/h；Alt+点徽标切换"仅文件页/全站"；兼容 PJAX 与 raw 页面。
// @author       You
...
(function () {
  ...
  /* 桌面默认顶部；若想桌面也底部：把下一行改为 top:auto; bottom:0; */
  .gplus-shbar{ top:0; }
